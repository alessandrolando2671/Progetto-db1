    ...
    if(isset($_POST['evento'])) {
        ...
        if(isset($_POST['aggiorna'])) {
            ...
            try {
                ...
                <form action="event_list.php" style="display:flex; justify-content:center" method="post">
                ...
                <form action="update.php" method="post" class="modulo">
                    <div class="container1">
                        <div class="container2">
                            ...
                            <input type="radio" id="statale" name="classificazione" value="A" '.($ris['Class_strada'] == 'A' ? 'checked' : '').'>
                            <label for="statale">Autostrada</label><br>
                            <input type="radio" id="statale" name="classificazione" value="E" '.($ris['Class_strada'] == 'E' ? 'checked' : '').'>
                            <label for="statale">Itinerario</label><br>
